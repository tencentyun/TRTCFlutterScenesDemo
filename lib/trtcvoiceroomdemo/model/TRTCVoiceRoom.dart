...
abstract class TRTCVoiceRoom {
     ...
     */
    static TRTCVoiceRoom sharedInstance() {
     ...
     */
    abstract void setDelegate(TRTCVoiceRoomDelegate delegate);
     ...
     */
    void login(int sdkAppId, String userId, String userSig, TRTCVoiceRoomCallback.ActionCallback callback);

    /**
     * 退出登录
     */
    void logout(TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    void setSelfProfile(String userName, String avatarURL, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    void createRoom(int roomId, TRTCVoiceRoomDef.RoomParam roomParam, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    void destroyRoom(TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    void enterRoom(int roomId, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    void exitRoom(TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    void getRoomInfoList(List<Integer> roomIdList, TRTCVoiceRoomCallback.RoomInfoCallback callback);

    /**
     * 获取指定userId的用户信息，如果为null，则获取房间内所有人的信息
     * @param userlistcallback 用户详细信息回调
     */
    void getUserInfoList(List<String> userIdList, TRTCVoiceRoomCallback.UserListCallback userlistcallback);
     ...
     * @param callback 操作回调
     */
    void enterSeat(int seatIndex, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 操作回调
     */
    void leaveSeat(TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 操作回调
     */
    void pickSeat(int seatIndex, String userId, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 操作回调
     */
    void kickSeat(int seatIndex, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 操作回调
     */
    void muteSeat(int seatIndex, boolean isMute, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 操作回调
     */
    void closeSeat(int seatIndex, boolean isClose, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    void setSpeaker(boolean useSpeaker);
     ...
     */
    void sendRoomTextMsg(String message, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 发送结果回调
     */
    void sendRoomCustomMsg(String cmd, String message, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    String sendInvitation(String cmd, String userId, String content, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     */
    void acceptInvitation(String id, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 接受操作的回调
     */
    void rejectInvitation(String id, TRTCVoiceRoomCallback.ActionCallback callback);
     ...
     * @param callback 接受操作的回调
     */
    void cancelInvitation(String id, TRTCVoiceRoomCallback.ActionCallback callback);
}
