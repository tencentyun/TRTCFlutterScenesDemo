...
TRTCMeeting 是一个开源的 Class，依赖腾讯云的两个闭源 SDK，具体的实现过程请参见 [多人视频会议（Flutter）](https://tcloud-doc.isd.com/document/product/647/58405)。
...
获取 [TRTCMeeting](https://tcloud-doc.isd.com/document/product/647/58405) 单例对象。
```dart
...
销毁 [TRTCMeeting](https://tcloud-doc.isd.com/document/product/647/58405) 单例对象。
```dart
...
设置事件监听，您可以通过 TRTCMeetingDelegate 获得 [TRTCMeeting](https://tcloud-doc.isd.com/document/product/647/58405) 的各种状态通知。
```dart
